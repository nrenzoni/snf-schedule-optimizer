...
from snf_schedule_optimizer.sqlalchemy_models.overtime_rule_config import (
    OvertimeRuleConfig,
)
...
class SQLAOvertimeRuleRetriever(IOvertimeRuleRetrieverService):
    ...
    def _map_db_record_to_rule(
        self, record: OvertimeRuleConfig
    ) -> ThresholdOvertimeRule:
        """
    ...
    def get_applicable_rules(
        ...
        db_records: Iterable[OvertimeRuleConfig] = (
