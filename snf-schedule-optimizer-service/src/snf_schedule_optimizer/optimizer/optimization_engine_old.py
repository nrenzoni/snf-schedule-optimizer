...
#             shifts, facility_config, min_mandate
#         )
#
...
#             return ScheduleOptimizationResults(False, None, None, infeasibility_result)
#
#         problem = self.set_objective_function(
#             shifts, lp_vars_holder, preference_weights, problem
#         )
#
...
#                 required_count = required_hprd_per_position_holder[
#                     shift.shift_id, hprd_enforced_role
#                 ]
#                 if required_count > 0:
...
#                                     lp_variables_holder.get_variable(
...
#
#                     problem += (
#                         pulp.lpSum(available_for_shift) >= required_count,
...
#             nurses_both_shifts = set(all_nurses_shift_1).intersection(
#                 all_nurses_shift_2
#             )
#             for nurse in nurses_both_shifts:
#                 problem += (
#                     lp_variables_holder.get_variable(
#                         nurse.employee_id, shift_1.shift_id
#                     )
#                     + lp_variables_holder.get_variable(
#                         nurse.employee_id, shift_2.shift_id
#                     )
#                     <= 1,
...
#             for nurse in nurses:
#                 turnover_risk = get_model_outputs.turnover_risk_scores.get(
#                     nurse.employee_id, 0.0
#                 )
#
#                 employee = self.employee_retriever.get_employee_by_id(nurse.employee_id)
#                 if employee is None:
#                     print(
#                         f"Employee {nurse.employee_id} not found for shift {shift.shift_id}"
#                     )
#                     continue
#
#                 employee_shift_lp_var = var_holder.get_variable(
#                     nurse.employee_id, shift.shift_id
#                 )
#
...
#                     penalty_cost += (
#                         turnover_risk * preference_weights.high_risk_shift_penalty
#                     )
#
...
#             for nurse in nurses:
#                 lp_variable_holder.add_variable(nurse.employee_id, shift.shift_id)
#
#     # =======================================================
