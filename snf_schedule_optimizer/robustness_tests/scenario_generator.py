...
class SimulateFacilityScenario:
...
def generate_simulated_nurses(simulation_params: SimulateFacilityScenario) -> List[NurseProfile]:
...
def generate_simulated_acuity(stress_params: TimeSeriesStressTestParameters) -> List[ResidentAcuity]:
    ...
    for i in range(int(base_count)):
        ...
        residents.append(ResidentAcuity(
            resident_id=f"R_{i}",
