            ...
            {selectedNurse ? (
                <>
                    <div className="flex justify-between items-start mb-4">
                        <h4 className="text-2xl font-bold text-indigo-700">{selectedNurse.name}</h4>
                        <button onClick={closeNurseDetails}
                    ...
                    <div className="mb-6 p-4 bg-white rounded-lg shadow-md">
                        <p className="font-semibold text-gray-700 mb-2">Scheduling Rationale:</p>
                        <p className="text-sm text-gray-600 italic">{selectedNurse.schedulingRationale}</p>
                    </div>
                    ...
                    <div className="space-y-3">
                        <button onClick={() => removeNurseFromShift(selectedNurse)}
